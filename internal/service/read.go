...
func (s *ReadService) ToolExecutables(ctx context.Context, tool model.Tool) (map[string]string, error) {
	...
	names := map[model.Tool][]string{model.Java: {"java"}, model.Maven: {"mvn"}, model.MVND: {"mvnd"}, model.Gradle: {"gradle"}, model.Rust: {"rustc", "cargo"}, model.Go: {"go"}, model.NodeJS: {"node", "npm", "npx"}}[tool]
